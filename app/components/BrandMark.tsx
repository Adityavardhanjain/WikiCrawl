...
export function BrandMark({ showWordmark = false }: BrandMarkProps) {
  return (
    <div className={`brand-lockup ${showWordmark ? 'brand-lockup-wordmark' : 'brand-lockup-mark'}`} aria-label="WikiCrawl">
      <svg className="brand-network-mark" viewBox="0 0 120 92" role="img" aria-label="WikiCrawl network mark">
